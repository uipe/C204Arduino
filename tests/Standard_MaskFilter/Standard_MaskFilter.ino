...
void setup()
{
  ...
  CAN0.init_Mask(0,0,0x3ff);                // Init second mask... 
  CAN0.init_Filt(0,0,0x0de);                // Init third filter...
  //CAN0.init_Filt(1,0,0x00450000);                // Init fouth filter...
  //CAN0.init_Filt(2,0,0x03f60000);                // Init fifth filter...
